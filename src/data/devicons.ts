...
import lodash from "devicon/icons/lodash/lodash-original.svg";
import reactnative from "devicon/icons/reactnative/reactnative-original.svg";
import threejs from "devicon/icons/threejs/threejs-original.svg";
import type { DevIcons } from "@/types/devicon-types";

export const devicons: Record<DevIcons, string> = {
  html: html,
  css: css,
  js: js,
  java: java,
