            ...
            <div className='w-full max-w-[50rem] flex flex-col gap-24 md:my-24 my-16 not-md:px-6 pb-40 '>
                ...
                <section className='flex flex-col gap-4'>
                    ...
                    <motion.p
                        ...
                        I’m Sudip Mahata (@imsudipdev), an 18-year-old self-taught software engineer and full-stack developer focused on building practical, scalable software.

                        I’m the founder of Imago and the creator of Skibidi Lang, a Gen-Z experimental programming language built for learning, fun, and exploring language design.

                        As a freelancer and ROM tester, I’ve worked hands-on with real systems — solving technical problems, optimizing user experience, and experimenting with new technologies across platforms.

                        I currently work with JavaScript, Python, and Rust, and actively explore AI integration, operating systems, and cross-platform development. My projects range from social platforms and browsers to code editors and community tools.

                        My goal is to grow as a strong problem solver and technical lead by continuously building, learning, and shipping meaningful software.
                    </motion.p>
                </section>
